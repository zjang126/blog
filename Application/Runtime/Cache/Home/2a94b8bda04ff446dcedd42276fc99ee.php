    ...
    <nav class="navbar navbar-default" id="navbar">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <h1 class="logo hvr-bounce-in"><a href="" title=""><img src="/Public/Home/images/logo.png" alt=""></a></h1>
            </div>
            <div class="collapse navbar-collapse" id="header-navbar">
                <ul class="nav navbar-nav navbar-right">
                    <li class="hidden-index active"><a data-cont="路非鸣首页" href="index.html">路非鸣首页</a></li>
...
<section class="container">
  <div class="content-wrap">
    <div class="content">
      ...
      <article class="excerpt excerpt-1"><a class="focus" href="article.html" title=""><img class="thumb" data-original="/Public/Home/images/excerpt.jpg" src="/Public/Home/images/excerpt.jpg" alt=""></a>
      ...
      <div class="widget widget-tabs">
        ...
        <div class="tab-content">
          <div role="tabpanel" class="tab-pane notice active" id="notice">
            <ul>
              <li>
                ...
                <a href="" target="_blank">欢迎访问路非鸣博客</a></li>
              <li>
                <time datetime="2016-01-04">01-04</time>
          ...
          <div role="tabpanel" class="tab-pane contact" id="contact">
            <h2>Email:<br />
              <a href="mailto:admin@ylsat.com" data-toggle="tooltip" data-placement="bottom" title="admin@ylsat.com">624141368@qq.com</a></h2>
          </div>
        </div>
      </div>
      ...
      <form action="/Home/Index/login" method="post">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="loginModalUserNmae" name="username" placeholder="请输入用户名" autofocus maxlength="15" autocomplete="off" required>
          </div>
          <div class="form-group">
            <label for="loginModalUserPwd">密码</label>
            <input type="password" class="form-control" id="loginModalUserPwd" name="password" placeholder="请输入密码" maxlength="18" autocomplete="off" required>
          </div>
        </div>
        <div class="modal-footer">
...
<div id="rightClickMenu">
  <ul class="list-group rightClickMenuList">
    <li class="list-group-item disabled">欢迎访问路非鸣博客</li>
