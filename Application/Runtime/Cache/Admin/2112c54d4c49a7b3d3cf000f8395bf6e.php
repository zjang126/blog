...
<article class="cl pd-20">
	<form action="/Admin/User/upd" method="post" class="form form-horizontal" id="form-admin-add">
		<input type="hidden" name="id" value="<?php echo $data['id'] ?>">  <!-- 在同一个页面两种提交方式要在隐藏域加多个id获取id-->
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text" autocomplete="off" value="" placeholder="不填寫默認舊密码" id="password" name="password">
			</div>
		</div>
		<div class="row cl">
