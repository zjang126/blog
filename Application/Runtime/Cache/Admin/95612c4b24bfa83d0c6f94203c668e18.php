...
<article class="cl pd-20">
	<form action="/Admin/Category/add" method="post" class="form form-horizontal" id="form-admin-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>分类：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="adminName" name="cat_name">
			</div>
		</div>
          <div  class="row cl">
			  <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>存在分类：</label>
			  <div class="formControls col-xs-8 col-sm-9">
			  <select name="pid" id="" class="input-text">可选分类
